...
5. [Guía Paso a Paso](#guía-paso-a-paso)
    - [1. Clonar y abrir el DevContainer](#1-clonar-y-abrir-el-devcontainer)
    - [2. Provisionar infraestructura en AWS](#2-provisionar-infraestructura-en-aws)
    - [3. Preparar la EC2 con Ansible](#3-preparar-la-ec2-con-ansible)
    - [4. Build y Push de Apps (Go/Python) a ECR](#4-build-y-push-de-apps-gopython-a-ecr)
    - [5. Desplegar en EC2 con Docker Compose](#5-desplegar-en-ec2-con-docker-compose)
    - [6. Automatización CI/CD con GitHub Actions](#6-automatización-cicd-con-github-actions)
    - [7. Jenkins: CI/CD alternativo y laboratorio](#7-jenkins-cicd-alternativo-y-laboratorio)
...
flowchart TD
    ...
    C1 -.-> C2
Pre-requisitos
Cuenta AWS con Free Tier activa: Crear cuenta
